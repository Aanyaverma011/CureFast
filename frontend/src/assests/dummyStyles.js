...
export const footerStyles = {
  ...
  mobileSubscribeButton: "w-full inline-flex items-center justify-center gap-2 py-3 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300",
  mobileButtonIcon: "w-4 h-4",
  
  
// Desktop newsletter
desktopNewsletterContainer:
  "hidden lg:flex flex-col gap-4 w-full max-w-md",

desktopEmailInput:
  "w-full px-6 py-4 text-base text-emerald-800 bg-white border-2 border-emerald-200 rounded-2xl focus:outline-none focus:ring-4 focus:ring-emerald-300 focus:border-emerald-400 transition-all duration-300 shadow-lg placeholder-emerald-400",

desktopSubscribeButton:
  "w-full flex items-center justify-center gap-2 px-6 py-4 rounded-2xl bg-gradient-to-r from-emerald-500 to-green-600 text-white font-semibold shadow-lg hover:shadow-2xl hover:scale-[1.02] transition-all duration-300",
...
export const homeDoctorsStyles = {
  ...
  image: "w-full h-full object-contain  transform transition-transform duration-500 bg-white",
