...
import { contactPageStyles } from '../assests/dummyStyles';
...
<div className={contactPageStyles.gridContainer}>
        ...
        <form onSubmit={handleSubmit} className={contactPageStyles.formSpace}>
            <div className={contactPageStyles.formGrid}>
                <div>
                    ...
                    <input name='name' value={form.value} onChange={handleChange} placeholder='Full Name' className={contactPageStyles.input}/>
                    {errors.name && (
            ...
            <div className={contactPageStyles.buttonContainer}>
                ...
                {sent && (
                    <p className={contactPageStyles.sentMessage}>Opening WhatsApp ans clearing form...</p>
                )}
            </div>
        </form>
    </div>
 ...
 <p className={contactPageStyles.infoText}>GomtiNagar, Lucknow, Uttar Pradesh</p>
