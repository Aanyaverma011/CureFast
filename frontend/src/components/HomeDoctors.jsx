...
import { homeDoctorsStyles, iconSize } from '../assests/dummyStyles';
                        ...
                        <div className={homeDoctorsStyles.cardBody}>
                          ...
                          <div className={homeDoctorsStyles.buttonContainer}> 
                            <div className="w-full">
                              {doctor.available  ? (
                                <Link to={`/doctors/${doctor.id}`} state={{doctor: doctor.raw || doctor}} className={homeDoctorsStyles.buttonAvailable}>
