...
const fileRef = useRef(null);
  ...
  async function handleSubmit(e) {
    ...
    <div className={addServiceStyles.toast.container}>
      {toast && (
        <div className={`${addServiceStyles.toast.toastBase} ${toast.type==="error" ? addServiceStyles.toast.toastError : toast.type === "info" ? addServiceStyles.toast.toastInfo : addServiceStyles.toast.toastSuccess} animmate-slideIn`}>
