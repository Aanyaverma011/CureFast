...
import { Search, X, CheckCircle, XCircle, Loader2, SearchIcon, Phone, User, Calendar, BadgeIndianRupee, Clock } from "lucide-react";
      ...
      {loading ? (
        ...
        <div className={serviceAppointmentsStyles.gridContainer}>
          {displayList.length === 0 ? (
            ...
            displayList.map((a) => {
              const isLoaded = a.status==="Completed" || a.status === "Canceled";
            return (
