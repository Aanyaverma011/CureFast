...
export const navbarStyles = {
  ...
  navContainer: "mx-auto max-w-7xl lg:px-7 xl:px-2 px-4 py-2",
  flexContainer: "flex items-center justify-between",
  
  // Logo section styles
  logoContainer: "flex items-center gap-2",
  logoImage: "w-19 h-19 rounded-full",
  logoLink: "text-lg font-bold text-green-700",
logoSubtext: "text-[10px] text-gray-500",
 
// Center navigation (desktop)
centerNavContainer: "hidden lg:flex items-center justify-center relative",
  glowEffect: "glow relative rounded-3xl p-1 bg-gradient-to-r from-emerald-100 via-emerald-200 to-emerald-100",
  centerNavInner: "relative flex items-center",
  centerNavScrollContainer: "center-inner relative whitespace-nowrap rounded-3xl bg-white/95 lg:px-2 px-2 py-1 flex items-center gap-4 shadow-lg border border-gray-100 overflow-x-auto",
  
  // Center nav items
  centerNavItemBase: "relative flex flex-col lg:text-xs lg:-mx-2 xl:text-md items-center gap-1.5 px-3 py-1.5 rounded-lg transition-all text-sm",
